    ...
    <div class="container">
        <div class="screen">
            <div class="screen__content">
				<span class="float-end"><a href="{{route('login')}}" class="btn text-white">Sign In</a></span>
                <form class="login" action="{{route('register')}}" method="post">
                    ...
                    <div class="login__field">
                        <i class="login__icon fas fa-lock"></i>
                        <input type="password" class="login__input" name="password_confirmation" placeholder="Rep-Password">
                    </div>
